LEXICON_RU: dict[str, str] = {
    '/start': '<b>Привет!</b> 👋 \n\n'
              ...
              '🔹 /parser - парсер с графиками 6 бк\n'
              '🔹 /locks - замки Fonbet\n\n'
    ...
    '/help': '<b>Привет! Я бот-парсер.</b> Вот, что я умею:\n\n'
             ...
             '📍 Также не забывай про меню <b>замков Fonbet</b> 📍\n'
             '  Чтобы посмотреть - жми /locks',
    ...
    '/locks': '<b>Меню для просмотра замков Fonbet!</b>\n'
              'Выберите категорию📍 матчей:',
    '/parser': '📈 <b>Визуализация</b> и 📊 <b>хронология</b>\nкоэффициентов матчей',
    'error': 'Извините, я не распознал эту команду.\nПожалуйста, введите /help, чтобы\nознакомиться с доступными опциями.',
    'cancel_zam': '🔒 <b>Вы покинули меню замков Fonbet.</b>\nВозвращайтесь скорее 🏆',
    'cancel_mat': '<b>Вы покинули меню парсера</b>📈',
    'cancel': 'ВЫЙТИ',
