...
async def process_start_command(message: Message, db_host, db_database, db_user, db_password, db_port, admin_ids):
    ...
    await get_users(message, db_host, db_database, db_user, db_password, admin_ids, db_port)
...
async def process_help_command(message: Message, db_host, db_database, db_user, db_password, db_port):
    await message.answer(text=LEXICON_RU['/pass'][await get_status_pass(message, db_host, db_database, db_user, db_password, db_port)])
...
async def process_settings_param(callback: CallbackQuery, db_host, db_database, db_user, db_password, db_port):
    await callback.message.edit_text(
        ...
        reply_markup=create_kb_params(await get_info_settings(callback.from_user.id, callback.data, db_host, db_database, db_user, db_password, db_port))
    )
...
async def process_settings_param(callback: CallbackQuery, db_host, db_database, db_user, db_password, db_port):
    await callback.message.edit_text(
        text=LEXICON_RU[callback.data],
        reply_markup=create_kb_edit_params(callback.data, await get_info_settings(callback.from_user.id, callback.data.lstrip('edit_'), db_host, db_database, db_user, db_password, db_port))
    )
...
async def process_settings_param(callback: CallbackQuery, db_host, db_database, db_user, db_password, db_port):
    ...
    await edit_params_del(callback.from_user.id, callback.data, db_host, db_database, db_user, db_password, db_port)
    await callback.answer()
...
async def process_settings_param(callback: CallbackQuery, db_host, db_database, db_user, db_password, db_port):
    ...
    await edit_params_add(callback.from_user.id, callback.data, db_host, db_database, db_user, db_password, db_port)
    await callback.answer()
...
async def process_settings_param(callback: CallbackQuery, db_host, db_database, db_user, db_password, db_port):
    ...
    await edit_params_pro(callback.from_user.id, callback.data, db_host, db_database, db_user, db_password, db_port)
    await callback.answer()
